    ...
    if cn.is_connected()==False:
        ...
        if people!='' and days!='' and hotel!='' and customer!='':
            ...
            if hotel=='Borcelle Resorts' or hotel=='Borcelle':
                hotel_id=1
                st1="insert into Gym values({},{},{},{},{});".format(customer,hotel_id,people,days,'NULL')
                cr.execute(st1)
                cn.commit()
            ...
            st="update Gym set Price=(Number_of_people*Number_of_days)*800;"
            cr.execute(st)
            cn.commit()
            cn.close()
...
hotelname=Entry(window,width=30,fg='black',border=0,font=('Microsoft YaHei UI Light',11))
...
customer_id=Entry(window,width=30,fg='black',border=0,font=('Microsoft YaHei UI Light',11))
